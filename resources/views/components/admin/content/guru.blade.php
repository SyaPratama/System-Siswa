...
@section('content')
    ...
    <div class="relative overflow-x-auto sm:rounded-lg">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-slate-500 dark:text-gray-400">
                <tr>
                ...
                @foreach ($guru as $idx => $item)
                    <tr
                        ...
                        <td class="px-6 py-4 flex gap-2">
                            ...
                            <button data-id="{{ route('guru.delete',$item->id) }}" data-modal-target="guru-modal" data-modal-toggle="guru-modal"
